...
import arnavigation.appsan.com.myapplication.network.DirectionsResponse;
import arnavigation.appsan.com.myapplication.network.RetrofitInterface;
import arnavigation.appsan.com.myapplication.network.model.Step;
...
/**
 * Created by Santhosh Adiga on 27-03-2018.
 */
...
//        Directions_call();
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location==null){
            ...
            speed.setText("00 km/h");
        }
        else{
            //int speed=(int) ((location.getSpeed()) is the standard which returns meters per second. In this example i converted it to kilometers per hour

            int vel=(int) ((location.getSpeed()*3600)/1000);

            speed.setText(vel+"  KM/H");
        }
    }
}
